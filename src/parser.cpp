...
Parser::Parser(std::string_view program_name) :
    m_program_name{program_name}
{}

void Parser::add_option(std::string_view description,
                        bool requires_argument,
                        std::string_view long_identifier,
                        const std::optional<char>& short_identifier) {
...
std::string_view Parser::get_option_value(std::string_view name) const {
...
void Parser::process_long_option(std::string_view option_name, std::string_view option_argument) {
...
void Parser::process_short_option(char short_option_name, std::string_view option_argument) {
    ...
    std::cerr << m_program_name
        << ": unknown option: -" << short_option_name << "\n";
    std::exit(1);
}
...
void Parser::print_options(std::vector<std::string_view> print_order) const {
    std::cout << "Options: \n";
